...
<?php
    ...
    if (isset($_GET["id"]))
    {
        ...
        if ($num != 0)
        {
            ...
            {
                echo "<td id=\"news_title\" colspan=\"2\">".$myrow["FirstName"]." ".$myrow["LastName"]." (".$myrow["login"].")&nbsp;|&nbsp;<a href=\"delete_user.php?id=".$myrow["id"]."\">".$lang["users_delete"]."</a></td>\n";
            }
            else
            {
            ...
            echo "<td id=\"news_title\"><center>".$lang["role_user"]."</center></td>\n";
            echo "</tr>\n";
            echo "<tr>\n";
